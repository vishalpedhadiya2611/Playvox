...
const HeroBanner = () => {
  return (
    <div className="bg-hero-pattern w-full bg-cover">
      <div className="flex flex-col md:flex-row mx-auto relative px-[24px] py-[21px] ts:py-0 ts:px-0 max-w-[1008px] ts:h-[461px] items-end overflow-hidden justify-end">
        <div className="ts:py-[115px] ts:absolute ts:w-[487px] top-0 left-0">
          <h3 className="font-extrabold	text-4xl mb-[21px]">
            Earn cashback upto <br className="hidden sm:block"/> ₹300 on App download!{" "}
          </h3>
          <div className="font-normal text-base mb-[28px] max-w-[449px]">
        ...
        <div className="flex justify-end items-end h-full">
          <Image
            ...
            width={794}
            height={519}
            className="mb-[-81px] ts:mb-[-48px] h-[278px] ts:h-[480px] mr-[-20px] w-full "
          />
        </div>
      </div>
    </div>
